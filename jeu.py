...
def main_game(existing_screen=None):
    ...
    key_a_pressed = False   #il faut modifier ca si on veut passer en qwerty
    key_d_pressed = False
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if not banane_manager.paused:
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_a:                            #il faut modifier ca si on veut passer en qwerty
                        key_a_pressed = True                            #il faut modifier ca si on veut passer en qwerty
                ...
                if event.type == pygame.KEYUP:
                    if event.key == pygame.K_a and key_a_pressed: #il faut modifier ca si on veut passer en qwerty
                        key_a_pressed = False                   #il faut modifier ca si on veut passer en qwerty
        ...
        if not banane_manager.paused:
            ...
            if keys[pygame.K_w]: #il faut modifier ca si on veut passer en qwerty
